  ...
  render() {
    return (
      <div className="app">
        ...
        >
          <div className="app__content">{/*Texto de los temas del primer toggle */}
            ...
            {/*<img className="image" alt="random" src={logo}/>*/}
        ...
        >
          Tarjetas De Crédito {/*segundo TOGGLE--------------------------------------------------------*/}
        </button>
          ...
          render={collapseState => (
            <React.Fragment>
              <div className="app__content">
                <div>{collapseState}</div>{/*Texto de los temas segundo toggle */}
        ...
        >
          Cuentas Bancarias Y Tarjetas De Débito {/*tercer TOGGLE----------------------------------------------------------*/}
        </button>
